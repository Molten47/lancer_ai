...
const Unique = () => {
  ...
  return (
    <div className="bg-[#F9FAFB] h-[90vh] py-16 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-[32px] font-semibold basic-font text-gray-900 mb-4">What makes Lancer different?</h2>
          <p className="text-[1.2rem] text-dark basic-font max-w-3xl mx-auto mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-18">
          {features.map((feature) => (
            <div 
              key={feature.id} 
              className="bg-[#DBEAFE] rounded-lg p-8 shadow-sm flex flex-col basic-font gap-2"
            >
              <div className="bg-white text-primary w-12 h-12 rounded-full flex items-center justify-center mb-6">
                {feature.icon}
              </div>
              <h3 className="text-xl text-primary font-semibold text-gray-900 mb-3">
                {feature.title}
              </h3>
              <p className="text-dark font-medium text-[1.2rem]">
                {feature.description}
              </p>
            </div>
          ))}
