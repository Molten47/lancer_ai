...
const Philosophy = () => {
  ...
  return (
    <div className={`w-full ${isMobile ? 'min-h-[70vh]' : 'min-h-[85vh]'} bg-[#151B25] third-font py-6 sm:py-2 md:py-10 lg:py-8 flex flex-col justify-center items-center px-4 sm:px-6 md:px-8`}>      
      
      {/* Logo Scroll Container */}
      <div className='w-full overflow-hidden relative py-4 sm:py-2 mb-4 sm:mb-2'>
