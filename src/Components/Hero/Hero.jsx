...
// Modified to accept onExplore as a prop
const Hero = ({ onExplore }) => {
  ...
  // Use the onExplore prop passed from parent
  ...
  return (
    <div className='hero-container w-full flex flex-col justify-center items-center min-h-[80vh] z-1 p-4 sm:p-8 md:p-12 relative' style={imageDisplay}>
      ...
      ></div>
      <div className='flex flex-col justify-center items-center text-center p-4 sm:p-6 md:p-10 z-50 relative'>
      ...
      <div className='mt-4 z-20 relative'>
        <button 
          ...
          className='py-2 sm:py-2.5 px-8 sm:px-10 bg-cta rounded-lg text-light basic-font hover:bg-[#00b5b5]'
        >
          Explore
        </button>
      </div>
