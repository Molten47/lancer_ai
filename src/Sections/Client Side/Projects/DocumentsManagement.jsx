...
import { ChevronLeft, Grid3X3, List, Plus, Download, Folder, Briefcase, FileText, File, Image, Package, Search, ArrowLeft } from 'lucide-react';
...
export default function FileManager() {
  ...
  const getFileIcon = (type) => {
    ...
    const icons = {
      doc: <FileText {...iconProps} className='text-blue-500' />,
      pdf: <FileText {...iconProps} className='text-red-500' />,
      sheet: <FileText {...iconProps} className='text-green-500' />,
      image: <Image {...iconProps} className='text-purple-500' />,
      zip: <Package {...iconProps} className='text-orange-500' />
    };
    return icons[type] || <File {...iconProps} />;
  };
